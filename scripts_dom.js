...
function start() {
    //allows button to pull data for table when pressed
...
//function used to control stop button
//stops timer and table when pressed
function stop() {
    clearInterval(timer);
...
//used to hold data that will be used for table
class InputData {
    constructor(
        time_seconds,
        latitude,
...
//function that allows to pull data for table
function getData() {
    var loadedData = loadData();
    return loadedData;
}
// function that assigns parameters for data within table
